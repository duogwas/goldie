...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ViewHolder> {
    ...
    public CategoryAdapter(List<CategoryResponse> categoryDomains, Context context) {
...
//
//        // Bây giờ bạn có thể sử dụng danh sách categoriesList theo ý muốn.
//        for (Category categoryItem : categoriesSubList) {
//            // Làm gì đó với mỗi categoryItem
